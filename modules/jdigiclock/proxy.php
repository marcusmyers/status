...
//$url = 'http://wwwa.accuweather.com/adcbin/forecastfox/weather_data.asp?location=' . $location;
$url = file_get_contents('http://wwwa.accuweather.com/adcbin/forecastfox/weather_data.asp?location=43545');
...
curl_close($ch);
*/
$xml = simplexml_load_string($url, 'SimpleXMLElement');
